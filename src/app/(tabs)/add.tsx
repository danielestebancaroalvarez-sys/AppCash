...
const styles = StyleSheet.create({
  ...
  modeHint: { color: Palette.textMuted, fontSize: 10 },
  section: {
    flexDirection: 'row',
    backgroundColor: Palette.glassFill,
    borderRadius: Radii.lg,
  ...
  sectionHint: { color: Palette.textMuted, fontSize: 11, marginTop: 1 },
  ...
  personName: { color: Palette.text, fontSize: 13, fontWeight: '600' },
  emptyBox: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
